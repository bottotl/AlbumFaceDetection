...
- (void)viewDidLoad {
    ...
    [JFTPhotoPickerViewController requestAuthorizationWithCompletionBlock:^(BOOL authorizated) {
        self.loader = [[JFTPhotosLoader alloc] init];
        self.models = [self.loader fetchModels];
